	...
	<table width="600" border="0" cellpadding="0" cellspacing="5"
		...
		<tr>
			<td align="right" width="450"><A
				href="freeboard_list03.jsp?go=<%= request.getParameter("page") %>"><img
			...
			<td width="70" align="right"><A
				href="freeboard_upd.jsp?id=<%= id %>&page=<%= request.getParameter("page") %>"><img
					src="image/edit.jpg" border=0></A></td>
			<td width="70" align="right"><A
				href="freeboard_del.jsp?id=<%= id %>&page=<%= request.getParameter("page") %>"><img
