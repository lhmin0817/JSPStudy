...
<body>
	...
	//String 형식으로 모두 넘어온다. Integer.parseInt()
	...
	*/
	//PreparedStatement 객체를 사용해서 처리, 변수에 들어가는 값을 ?로 처리
			//매번 컴파일 하지 않기 때문에 처리 속도가 빠름
	sql ="select * from freeboaed where id=?";
	pstmt=conn.prepareStatement(sql);
	pstmt.setInt(1, id);	// 첫번째 물은표, 들어갈 변수
	rs=pstmt.executeQuery();//select 문인 경우 executeQuery()
							//insert, update, delete문인 경우 : executUpdate()
	...
	<table width='600' cellspacing='0' cellpadding='2' align='center'>
		...
		<tr align='center' bgcolor='#DFEDFF'>
			<td class='button' bgcolor='#DFEDFF'>
				<div align='left'>
					<font size='4'>글 제목 :<pre><%=rs.getString("subject")%></pre>
				</div>
			</td>
		</tr>
	...
	<table width="600" border="0" cellpadding="0" cellspacing="5">
		<tr>
			<td align="right" width="450"><A href="#"><img
					src="freeboard_list.jpg" border=0></a></td>
			<td width="70" align="right"><A href="#"> <img
					src="freeboard_rwrite.jpg" border=0></A></td>
			<td width="70" align="right"><A href="#"><img
					src="freeboard_upd.jpg" border=0></A></td>
			<td width="70" align="right"><A href="#"><img
					src="freeboard_del.jsp" border=0></A></td>
		</tr>
	</table>
...
//Statement 객체의 select 쿼리인 경우 executeQuery(sql)를 실행 Resulrset 객체로 리턴
stmt=conn.createStatement();
